...
: ${AMENT_CURRENT_PREFIX:="/workspaces/gh_mk2/install/china_lidar_driver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/china_lidar_driver/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/china_lidar_driver/environment/path.sh"
